      ...
      <SidebarOptions>
        <SidebarOption>
          <div className="button m-4 px-4 py-2 active:text-white bg-white text-primary flex flex-row gap-2 items-center rounded-xl pl-[40px]">
            <StyledNavLink end to="/vehicle-management">
              View Vehicles
            </StyledNavLink>
          </div>
        </SidebarOption>
        <SidebarOption>
          <div className="button m-4 px-4 py-2 active:text-white bg-white text-primary flex flex-row gap-2 items-center rounded-xl pl-[40px]">
            <StyledNavLink end to="/vehicle-management/add-vehicle">
              Add Vehicle
            </StyledNavLink>
          </div>
        </SidebarOption>
        <SidebarOption>
          <div className="button m-4 px-4 py-2 active:text-white bg-white text-primary flex flex-row gap-2 items-center rounded-xl pl-[40px]">
            <StyledNavLink end to="/vehicle-management/category">
              View Categories
            </StyledNavLink>
          </div>
        </SidebarOption>
        <SidebarOption>
          <div className="button m-4 px-4 py-2 active:text-white bg-white text-primary flex flex-row gap-2 items-center rounded-xl pl-[40px]">
            <StyledNavLink end to="/vehicle-management/add-vehicle-category">
              Add Category
            </StyledNavLink>
          </div>
        </SidebarOption>
