  ...
  return `
      ...
      <main>
        <table>
         ...
         ${firewoodstock.map((fire) => {
            return (
            `<tr>
                <td class="service">${fire.supID}</td>
                <td class="desc">${fire.itemType}</td>
                <td class="desc">${fire.quantity}</td>
                <td class="desc">${fire.price}</td>
                <td class="unit">${fire.quantity * fire.price}</td> -->
