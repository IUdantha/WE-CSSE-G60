  ...
  return `
    ...
    <main>
      <table>
       ...
       ${Machine.map((mach) => {
         return `   <tr>
              <td class="service">${mach.machineID}</td>
              <td class="desc">${mach.machineModel}</td>
              <td class="desc">${mach.sectionNumber}</td>
              <td class="desc">${mach.brand}</td>
              <td class="unit">${mach.maintenanceCost}</td>
              <td class="desc">${
                mach.lastModifiedDate &&
                new Date(mach.lastModifiedDate).toLocaleDateString('en-US', {
                  timeZone: 'UTC'
                })
              }</td>
              <td class="unit">${mach.status}</td>
