module.exports = (packingmaterialstock) => {
  ...
  console.log(packingmaterialstock)
  // const total = 0
  ...
  return `
          ...
          <h1>Packing material Stock Details</h1>
        ...
        <main>
          <table>
           ...
           ${packingmaterialstock.map((pack) => {
              return (
              `<tr>
                  <td class="service">${pack.supID}</td>
                  <td class="desc">${pack.itemType}</td>
                  <td class="desc">${pack.quantity}</td>
                  <td class="desc">${pack.price}</td>
                  <td class="unit">${pack.quantity * pack.price}</td> -->
