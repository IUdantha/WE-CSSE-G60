...
app.use('/admin-portal/sales-management', auth, salesManagement, salesManagerRouters)

// Stock Management Route

app.use('/admin-portal/stock-management', auth, stockManagement, stockManagerRoutes)
...
app.use('/admin-portal/machine-management/machines', auth, technicalManagement, machineRoutes)
app.use('/admin-portal/machine-management/generators', auth, technicalManagement, generatorRoutes)
